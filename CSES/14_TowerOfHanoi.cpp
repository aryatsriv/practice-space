...
//  integers a and b: you move a disk from stack a to stack b. Constraints
//
//  1 \le n \le 16
//
//  Example
...
void tower_of_hanoi(int n,int from, int to){
	...
	//the result of below operation gives the missing number because we took all the available stacks number and subtracted what is already there
